        ...
        <div class="collapse navbar-collapse" id="topnav-menu-content">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle arrow-none" id="topnav-layout" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false" @click="onMenuClick">
                <i class="ri-layout-3-line me-2"></i>{{ $t('menuitems.layouts.text') }}
                <div class="arrow-down"></div>
              </a>
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                <a @click="change_layout('vertical')" class="dropdown-item">{{ $t('menuitems.layouts.list.vertical')
                  }}</a>
